...
export const setCurrentUser = (user) =>
  createAction(USER_ACTION_TYPE.SET_CURRENT_TYPE, user);


export const checUserSession = () => createAction(USER_ACTION_TYPE.CHECK_USER_SESSION)

export const googelSignInStart = () => createAction(USER_ACTION_TYPE.GOOGLE_SIGN_IN_START)
